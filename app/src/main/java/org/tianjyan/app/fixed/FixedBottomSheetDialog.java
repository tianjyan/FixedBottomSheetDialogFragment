...
public class FixedBottomSheetDialog extends AppCompatDialog {
    private FixedBottomSheetBehavior<FrameLayout> mBehavior;
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        final FrameLayout container = (FrameLayout) View.inflate(getContext(),
                R.layout.fixed_design_bottom_sheet_dialog, null);
        ...
        mBehavior = FixedBottomSheetBehavior.from(bottomSheet);
    ...
    private FixedBottomSheetBehavior.BottomSheetCallback mBottomSheetCallback
            = new FixedBottomSheetBehavior.BottomSheetCallback() {
        @Override
        public void onStateChanged(@NonNull View bottomSheet,
                                   @FixedBottomSheetBehavior.State int newState) {
